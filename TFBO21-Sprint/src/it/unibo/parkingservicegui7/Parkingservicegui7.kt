...
package it.unibo.parkingservicegui7
...
class Parkingservicegui7 ( name: String, scope: CoroutineScope  ) : ActorBasicFsm( name, scope ){
		...
		return { //this:ActionBasciFsm
				...
				state("requestToEnter") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t030",targetState="enterthecar",cond=whenReply("enter"))
				}	 
				...
				state("movethecartoindoor") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t031",targetState="afterreceipt",cond=whenReply("receipt"))
				}	 
				state("afterreceipt") { //this:State
					action { //it:State
						...
						stateTimer = TimerActor("timer_afterreceipt", 
							scope, context!!, "local_tout_parkingservicegui7_afterreceipt", 10000.toLong() )
					}
					 transition(edgeName="t032",targetState="reqpickup",cond=whenTimeout("local_tout_parkingservicegui7_afterreceipt"))   
				}	 
				state("reqpickup") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t033",targetState="waitForCarOutDoorArrival",cond=whenReply("pickupAccepted"))
				}	 
				state("waitForCarOutDoorArrival") { //this:State
					action { //it:State
					}
					 transition(edgeName="t034",targetState="pickup",cond=whenEvent("caroutdoorarrival"))
				}	 
