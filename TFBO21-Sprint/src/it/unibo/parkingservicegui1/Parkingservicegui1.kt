...
package it.unibo.parkingservicegui1
...
class Parkingservicegui1 ( name: String, scope: CoroutineScope  ) : ActorBasicFsm( name, scope ){
		...
		return { //this:ActionBasciFsm
				...
				state("requestToEnter") { //this:State
					action { //it:State
						...
						request("reqenter", "reqenter(name)" ,"parkingmanagerservice" )  
					}
				...
				state("afterreceipt") { //this:State
					action { //it:State
						...
						stateTimer = TimerActor("timer_afterreceipt", 
							scope, context!!, "local_tout_parkingservicegui1_afterreceipt", 10000.toLong() )
					}
					 transition(edgeName="t02",targetState="reqpickup",cond=whenTimeout("local_tout_parkingservicegui1_afterreceipt"))   
				}	 
				state("reqpickup") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t03",targetState="waitForCarOutDoorArrival",cond=whenReply("pickupAccepted"))
				}	 
				state("waitForCarOutDoorArrival") { //this:State
					action { //it:State
					}
					 transition(edgeName="t04",targetState="pickup",cond=whenEvent("caroutdoorarrival"))
				}	 
