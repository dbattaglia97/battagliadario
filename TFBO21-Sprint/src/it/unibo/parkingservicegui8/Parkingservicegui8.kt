...
package it.unibo.parkingservicegui8
...
class Parkingservicegui8 ( name: String, scope: CoroutineScope  ) : ActorBasicFsm( name, scope ){
		...
		return { //this:ActionBasciFsm
				...
				state("requestToEnter") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t035",targetState="enterthecar",cond=whenReply("enter"))
				}	 
				...
				state("movethecartoindoor") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t036",targetState="afterreceipt",cond=whenReply("receipt"))
				}	 
				state("afterreceipt") { //this:State
					action { //it:State
						...
						stateTimer = TimerActor("timer_afterreceipt", 
							scope, context!!, "local_tout_parkingservicegui8_afterreceipt", 10000.toLong() )
					}
					 transition(edgeName="t037",targetState="reqpickup",cond=whenTimeout("local_tout_parkingservicegui8_afterreceipt"))   
				}	 
				state("reqpickup") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t038",targetState="waitForCarOutDoorArrival",cond=whenReply("pickupAccepted"))
				}	 
				state("waitForCarOutDoorArrival") { //this:State
					action { //it:State
					}
					 transition(edgeName="t039",targetState="pickup",cond=whenEvent("caroutdoorarrival"))
				}	 
