...
package it.unibo.parkingservicegui6
...
class Parkingservicegui6 ( name: String, scope: CoroutineScope  ) : ActorBasicFsm( name, scope ){
		...
		return { //this:ActionBasciFsm
				...
				state("requestToEnter") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t025",targetState="enterthecar",cond=whenReply("enter"))
				}	 
				...
				state("movethecartoindoor") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t026",targetState="afterreceipt",cond=whenReply("receipt"))
				}	 
				state("afterreceipt") { //this:State
					action { //it:State
						...
						stateTimer = TimerActor("timer_afterreceipt", 
							scope, context!!, "local_tout_parkingservicegui6_afterreceipt", 10000.toLong() )
					}
					 transition(edgeName="t027",targetState="reqpickup",cond=whenTimeout("local_tout_parkingservicegui6_afterreceipt"))   
				}	 
				state("reqpickup") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t028",targetState="waitForCarOutDoorArrival",cond=whenReply("pickupAccepted"))
				}	 
				state("waitForCarOutDoorArrival") { //this:State
					action { //it:State
					}
					 transition(edgeName="t029",targetState="pickup",cond=whenEvent("caroutdoorarrival"))
				}	 
